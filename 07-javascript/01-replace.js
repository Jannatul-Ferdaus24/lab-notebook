...
console.log(
  replaceItems(
    "All that is gold does not glitter and those who wander are not always lost"
  )
);
// expected: 'All that is SHINY does not glitter and those who roam are not always lost'
